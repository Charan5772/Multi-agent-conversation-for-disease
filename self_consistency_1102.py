...
def process_single_case(args, dataset, idx, output_dir, model_config):
    ...
    groupchat = GroupChat(
        ...
        speaker_selection_method="round_robin",  #"auto" or "round_robin": ä¸ä¸ä¸ªåè¨èä»¥å¾ªç¯æ¹å¼éæ©ï¼å³æç§agentsä¸­æä¾çé¡ºåºè¿è¡è¿­ä»£.  ææä¸å¤ªçæ³ï¼éè¦æ´æ¹prompt
        admin_name="Critic",
